...
public class CassandraConfiguration {
    ...
    public static void init() {
        ...
        Author authorInsert = new Author(UUID.randomUUID(), "john", "smith", DateCassandra.dateStringToDate("2001-08-14 12:44"));
        authorMapper.save(authorInsert);

        Author authorUpdate = new Author(UUID.fromString("a51294df-0d16-4fb3-85e9-2e2ecc7ac1a2"), "joe", "doe", DateCassandra.dateStringToDate("1987-12-11 12:44"));
